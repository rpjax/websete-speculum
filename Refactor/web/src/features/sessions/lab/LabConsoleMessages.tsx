...
import { LabConsoleValue } from './LabConsoleValue'
import {
...
interface LabConsoleMessagesProps {
  lines: LabConsoleLine[]
  scrollerRef: RefObject<HTMLDivElement | null>
}

function SeverityIcon({ line }: { line: LabConsoleLine }) {
  if (line.kind === 'input') {
    return (
 ...
 */
export function LabConsoleMessages({ lines, scrollerRef }: LabConsoleMessagesProps) {
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1 break-words">
                  {showTree ? (
                    <LabConsoleValue value={parseConsoleValue(line.text)} />
                  ) : (
                    <pre
                      className={cn(
