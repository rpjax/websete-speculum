    ...
    items: [
      {
        ...
        helper: 'All engine sections at a glance',
      },
      {
        label: 'Hosting',
        href: '/w7s/admin/configurations/Hosting',
        icon: Globe,
        helper: 'Domains, certificates, edge',
      },
      {
        label: 'Navigation',
        href: '/w7s/admin/configurations/Navigation',
        icon: Compass,
        helper: 'Default target, allowlist',
      },
      {
        label: 'Sessions',
        href: '/w7s/admin/configurations/Sessions',
        icon: Activity,
        helper: 'Viewport, bridge, input policy',
      },
      {
        label: 'Resource management',
        href: '/w7s/admin/configurations/ResourceManagement',
        icon: SlidersHorizontal,
        helper: 'Admission, storage, retention',
      },
      {
        label: 'Journal',
        href: '/w7s/admin/configurations/Journal',
        icon: ScrollText,
        helper: 'Fact-log admission and drain',
      },
      {
        label: 'Telemetry',
        href: '/w7s/admin/configurations/Telemetry',
        icon: Sparkles,
        helper: 'Sampler, observation, events',
      },
      {
      ...
      {
        label: 'Maintenance',
        href: '/w7s/admin/maintenance',
        icon: Trash2,
        helper: 'Cleanup sessions, facts, profiles',
      },
    ],
  },
  {
