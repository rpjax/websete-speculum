"use strict";
/**
 * Node-side SessionPlane over the `ws` package (lab / future host).
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.PlaneChannel = exports.NodeSessionPlane = void 0;
...
class NodeSessionPlane {
    ...
    open(_url) {
        throw new Error('NodeSessionPlane.open: use attach(socket) on the server side');
    }
    close() {
        this.detach(true);
    }
...
exports.NodeSessionPlane = NodeSessionPlane;
//# sourceMappingURL=nodeSessionPlane.js.map