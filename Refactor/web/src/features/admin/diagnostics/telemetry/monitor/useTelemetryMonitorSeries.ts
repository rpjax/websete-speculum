...
/**
 * Loads the Monitor chart series for a range. Small ranges fetch raw samples;
 * long ranges use server-side downsampling so payloads stay bounded.
 */
export function useTelemetryMonitorSeries(
