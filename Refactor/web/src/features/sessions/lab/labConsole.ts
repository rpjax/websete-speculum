...
export type LabConsoleLineKind = 'log' | 'input' | 'result' | 'system'
...
export function consoleSeverity(line: LabConsoleLine): ConsoleSeverity {
 ...
 */
export function collapseConsoleRepeats(lines: LabConsoleLine[]): ConsoleMessageRow[] {
...
export function inputConsoleLine(id: number, code: string, at = Date.now()): LabConsoleLine {
