...
export const EVENT_DESCRIPTIONS: Record<string, string> = {
  ...
  'Motor.ResizeApplied': 'The remote viewport was applied and verified (client, Chrome, and Xvfb match).',
  'Motor.ResizeRejected': 'A viewport resize was rejected as invalid (below minimum or above ceiling).',
  'Motor.ResizeFailed': 'A viewport resize failed operationally; the last confirmed size was preserved.',
