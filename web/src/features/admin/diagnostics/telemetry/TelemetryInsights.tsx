...
/**
 * Auto-surfaces nonlinear resource↔sessions scaling anomalies. Each card links to the peak
 * sample so the operator can jump straight to the moment on the chart.
 */
  ...
  return (
    <div className="rounded-lg border border-border bg-card overflow-hidden">
      <div className="flex items-center gap-2 border-b border-border/30 px-3 py-1.5 bg-muted/5">
        ...
        <span className="text-[11px] text-muted-foreground/50">nonlinear scaling</span>
