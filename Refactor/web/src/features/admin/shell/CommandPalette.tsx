...
const goTo = [
  ...
  { label: 'Configurations overview', href: '/w7s/admin/configurations' },
  { label: 'Configure Hosting', href: '/w7s/admin/configurations/Hosting' },
  { label: 'Configure Navigation', href: '/w7s/admin/configurations/Navigation' },
  { label: 'Configure Sessions', href: '/w7s/admin/configurations/Sessions' },
  { label: 'Configure Resource management', href: '/w7s/admin/configurations/ResourceManagement' },
  { label: 'Configure Journal', href: '/w7s/admin/configurations/Journal' },
  { label: 'Configure Telemetry', href: '/w7s/admin/configurations/Telemetry' },
  { label: 'Host resources', href: '/w7s/admin/host-resources' },
  { label: 'Maintenance', href: '/w7s/admin/maintenance' },
  ...
  { label: 'Journal (diagnostics)', href: '/w7s/admin/diagnostics/timeline' },
