...
exports.buildExtensionPlaneMainShimJs = buildExtensionPlaneMainShimJs;
const envelope_1 = require("@speculum/page-projection/core/extensionPlane/envelope");
const extensionPlaneSocket_1 = require("@speculum/page-projection/virtual/transport/extensionPlaneSocket");
...
function buildExtensionPlaneMainShimJs() {
    const channel = envelope_1.EXTENSION_PLANE_CHANNEL;
    const factoryGlobal = extensionPlaneSocket_1.EXTENSION_PLANE_SOCKET_FACTORY_GLOBAL;
    const configGlobal = projectionConfig_1.PROJECTION_CONFIG_GLOBAL;
...
//# sourceMappingURL=extensionPlaneMainShim.js.map