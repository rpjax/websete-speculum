...
/// <summary>
/// PP-WIRE-1: <see cref="GrpcSessionMappers.ToPageProjectionDiff"/> must relay opaque
...
/// </summary>
public sealed class PageProjectionDiffMapperTests
{
    [Fact]
    public void BinaryFrame_EmptyPlaneAndOperation_RelaysBodyOpaquely()
    {
        ...
        var diff = GrpcSessionMappers.ToPageProjectionDiff(frame);
    ...
    public void EmptyEnvelope_NoBodyAndEmptyPlaneOperation_ReturnsNull()
    {
        ...
        Assert.Null(GrpcSessionMappers.ToPageProjectionDiff(frame));
    }
