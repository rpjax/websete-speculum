...
import { INPAGE_SCRIPT_V2_CORE } from './inpageScriptCore';
import { INPAGE_SCRIPT_V2_CSSOM } from './inpageScriptCssom';
import { INPAGE_SCRIPT_V2_OBSERVE } from './inpageScriptObserve';

/** Concatenated in-page IIFE — fragments only; algorithm unchanged. */
export const PAGE_PROJECTION_V2_PAGE_SCRIPT =
  INPAGE_SCRIPT_V2_CORE + INPAGE_SCRIPT_V2_CSSOM + INPAGE_SCRIPT_V2_OBSERVE;
