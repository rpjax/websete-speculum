...
| **Motor 0.3.0** | **In progress** — [motor-0.3.0.md](motor-0.3.0.md). **Motor milestone** (not production RBI). PP core lab-proven; tag blocked on gen-pack revert + redirect proof. |
