...
/// dev harness (evaluate / input). Journal InputApplied enabled only via explicit seed.
/// </summary>
[Collection(nameof(SessionsAssertCollection))]
[Trait("Category", "SessionsAssertive")]
public sealed class InputAssertTests : SessionsAssertTestBase
{
    public InputAssertTests(SessionsAssertFixture fixture) : base(fixture) { }
    ...
    public async Task C1_mouse_click_increments_fixture_counter()
    {
        ...
        await act.WaitJournalAsync("Sessions.InputApplied", TimeSpan.FromSeconds(10));
    }
    ...
    public async Task C4_invalid_input_type_does_not_mutate_page()
    {
        ...
        await act.WaitJournalAsync("Sessions.InputRejected", TimeSpan.FromSeconds(10));
