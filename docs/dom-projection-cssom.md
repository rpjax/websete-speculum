...
**Dom plane (sealed):** [dom-projection-diff-streams.md](dom-projection-diff-streams.md)
...
**Related:** [dom-projection-diff-streams.md](dom-projection-diff-streams.md)
(DOM plane) · [dom-projection-diff-pipeline.md](dom-projection-diff-pipeline.md)
...
| Docs | `dom-projection-*.md` filenames | Migrate to `page-projection-*.md` (or keep files temporarily with banners) under T12 — content vocabulary = PageProjection |
