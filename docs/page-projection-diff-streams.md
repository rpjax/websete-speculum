...
| T11 | Wire / proto / API / client apply cutover | **DONE** — PageProjection rename + Dom/Cssom ops |
| T12 | Docs migration (filenames + pipeline/coalesce) | **DONE** — `page-projection-*.md` |
...
T12: docs migration (`page-projection-*.md` → `page-projection-*.md` or banners;
