...
export function useLiveSession({
  ...
  const lifecycle = useSessionLifecycle({
    ...
    onPageProjectionFrame: observation.onPageProjectionFrame,
    ...
    onPageProjectionFrameEnded: observation.onPageProjectionFrameEnded,
  ...
  return {
    ...
    attachPageProjectionFrameSink: observation.attachPageProjectionFrameSink,
    attachPageProjectionLifecycleSink: observation.attachPageProjectionLifecycleSink,
    attachPageProjectionFrameEndedSink: observation.attachPageProjectionFrameEndedSink,
    observePageProjectionFrameApply: observation.observePageProjectionFrameApply,
