...
interface SmokeWireSettingsProps {
  origins: SmokeOrigins
  connectionId: string | null
  profileId: string | null
  sessionId: string | null
  disabled: boolean
  onApply: (origins: SmokeOrigins) => void
 ...
 */
export function SmokeWireSettings({
  origins,
  connectionId,
  profileId,
  sessionId,
  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        <Label htmlFor="smoke-hub-origin">Hub origin (SignalR /vhub)</Label>
        <Input
          id="smoke-hub-origin"
      ...
      <div className="space-y-2">
        <Label htmlFor="smoke-transport-origin">Transport origin (WebTransport /vtransport)</Label>
        <Input
          id="smoke-transport-origin"
          className="font-mono text-xs"
        ...
        />
        <p className="text-xs text-muted-foreground">
          Must be HTTPS + HTTP/3. Dockup smoke publishes the API at{' '}
