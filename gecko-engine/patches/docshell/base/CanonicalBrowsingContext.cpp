...
void CanonicalBrowsingContext::ReplacedBy(
  ...
  // Speculum: o contextId da aba projetada mora no campo sincronizado. Sem
  // copiá-lo na troca de BrowsingContext (bfcache, remoteness, COOP) o
  // produtor vê ctx=0 no documento novo e não anexa.
  txn.SetSpeculumContextId(GetSpeculumContextId());
