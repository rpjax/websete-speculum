...
const keycodes_1 = require("../../input/os/keycodes");
const logical_to_device_1 = require("../../input/os/logical-to-device");
const uinput_1 = require("../../input/os/uinput");
const eventNodes_1 = require("../../input/os/eventNodes");
...
class OsInputBackend {
    ...
    resolveEventPaths() {
        (0, eventNodes_1.ensureInputEventNodes)(this._pointer.name, this._keyboard.name, this._touch.name);
        const handlers = (0, eventNodes_1.listInputHandlers)(this._pointer.name, this._keyboard.name, this._touch.name);
