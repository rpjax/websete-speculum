...
| P1 | contract + surface | MirrorMode Dom gates + Live PP Frames stream delivers opaque body/contextId + RequestResync effect | `LiveSessionTests.MirrorMode_*` (incl. frame/resync surface asserts in `MirrorMode_PageProjection_GatesVideoAndOpensDomStream`) |
