...
{
    /// <summary>
    /// Maps a client motor URL to the target forwarding URL (subdomain mirroring ON).
    /// </summary>
    ...
    /// <summary>
    /// Maps a target site URL to the client motor URL (subdomain mirroring ON).
    /// </summary>
    ...
    /// <summary>
    /// Maps a target URL to apex motor URL (subdomain mirroring OFF).
    /// </summary>
