 ...
 * Streaming logs + REPL live in {@link LabConsolePanel}.
 */
export function LabEvalPanel({ live, jsBridgeEnabled, onEvaluate }: LabEvalPanelProps) {
