...
exports.foldCspNavLocale = foldCspNavLocale;
function actOk(chassis, name) {
...
function foldCspNavLocale(chassis) {
    const verdicts = [];
...
//# sourceMappingURL=cspNavLocale.js.map