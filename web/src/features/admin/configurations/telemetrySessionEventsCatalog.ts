...
export const TELEMETRY_SESSION_EVENT_GROUPS: TelemetrySessionEventGroup[] = [
  {
    ...
    events: [
      ...
      {
        type: 'Telemetry.Sessions.VideoStreamingInput.SidecarEnqueued',
        label: 'Hop 3 · Sidecar enqueued',
        help: 'Sidecar enqueued the input into the session pipeline (not applied yet).',
        hotPath: true,
      },
    ],
  },
  ...
  },
  {
    ...
    events: [
      ...
      {
        type: 'Telemetry.Sessions.PageProjection.Input.SidecarEnqueued',
        label: 'Hop 3 · Sidecar enqueued',
        help: 'Sidecar enqueued the intent on EventApplier (not yet CDP-applied).',
        hotPath: true,
      },
      {
