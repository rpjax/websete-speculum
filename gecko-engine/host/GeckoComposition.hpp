...
#include "engines/gecko/GeckoEngineCommands.hpp"
...
// Composition root with GeckoEngine — same ports as sim Composition.
class GeckoComposition {
 public:
  GeckoComposition()
      : commands_(engine_),
  ...
  gecko::GeckoEngine& gecko() { return engine_; }
  ...
  gecko::GeckoEngineCommands& commands() { return commands_; }
 ...
 private:
  ScriptedLink link_;
  ManualClock clock_;
  gecko::GeckoEngine engine_;
  gecko::GeckoEngineCommands commands_;
